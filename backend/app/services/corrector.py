...
def apply_groq_correction(text: str, correction_type: str, groq_api_key: Optional[str] = None) -> Optional[str]:
    """
    Apply correction using Groq API (free)
    ...
    try:
        ...
        # Prepare prompt based on correction type
        prompts = {
